...
export function AdminLogo({ className, variant = "compact" }: AdminLogoProps) {
  return (
    <svg
    ...
    >
      ...
      <rect x="148" y="167" width="88" height="6" rx="3" fill="currentColor" />
      <circle cx="172" cy="170" r="11" fill="currentColor" />
      <rect x="148" y="195" width="88" height="6" rx="3" fill="currentColor" />
      <circle cx="214" cy="198" r="11" fill="currentColor" />
      <rect x="148" y="223" width="88" height="6" rx="3" fill="currentColor" />
      <circle cx="190" cy="226" r="11" fill="currentColor" />
    </svg>
  );
}
